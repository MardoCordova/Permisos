...
<div class="col">
	<strong><h5 class="colorText">Hora Salida</h5></strong> 
	<label>{{$idSoli->hora_salida}}</label>
</div>


<div class="col">
	<strong><h5 class="colorText">Hora Entrada</h5></strong> 
	<label>{{$idSoli->hora_entrada}}</label>
</div>
